...
static inline void assert_param( unsigned test)
{
	if( test ==0)
		asm("bkpt 0");
}
...
/**
  ...
  * @retval None
  */
void DMA_Init(DMA_Stream_TypeDef* DMAy_Streamx, DMA_InitTypeDef_legacy* DMA_InitStruct)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void DMA_StructInit(DMA_InitTypeDef_legacy* DMA_InitStruct)
{
